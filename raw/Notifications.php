...
-->
        ...
        <div class="m-profile-main">
			<div id="m-profile-main-inner">
				<div class="spaceContainerTop"><h1>Notification Feed</h1></div>
					
				<a href="ProfileIntroPage.php"><button id="CreateGroupProfile">Back</button></a>	
				<br/>
				<br/>
				<div style="width:90%; height: 700px; background-color:red; left:0; right:0; margin: 0 auto;">
				test
				</div>
